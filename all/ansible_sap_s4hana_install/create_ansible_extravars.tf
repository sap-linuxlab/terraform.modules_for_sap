...
sap_swpm_templates_install_dictionary:
  ...
  sap_s4hana_2022_onehost_install:
    ...
    softwarecenter_search_list_x86_64:
      ...
      - 'IMDB_CLIENT20_014_24-80002082.SAR' # SAP HANA Client 2.14
...
#      - 'SUM20SP15_0-80002456.SAR' # SUM 2.0 SP15 Patch 0
    ...
    softwarecenter_search_list_ppc64le:
      ...
      - 'IMDB_CLIENT20_014_24-80002095.SAR' # SAP HANA Client 2.14
...
#      - 'SUM20SP15_0-80002470.SAR' # SUM 2.0 SP15 Patch 
  ...
  sap_s4hana_2021_onehost_install:
    ...
    softwarecenter_search_list_x86_64:
      ...
      - 'IMDB_LCAPPS_2064_0-20010426.SAR'
      - 'IMDB_AFL20_064_2-80001894.SAR'
      - 'IMDB_CLIENT20_014_24-80002082.SAR'
      - 'SWPM20SP13_3-80003424.SAR'
      - 'igsexe_1-70005417.sar' # IGS 7.81
      - 'igshelper_17-10010245.sar'
    ...
    softwarecenter_search_list_ppc64le:
      ...
      - 'IMDB_LCAPPS_2064_0-80002183.SAR'
      - 'IMDB_AFL20_064_2-80002045.SAR'
      - 'IMDB_CLIENT20_014_24-80002095.SAR'
      - 'SWPM20SP13_3-80003426.SAR'
      - 'igsexe_1-70005446.sar' # IGS 7.81
      - 'igshelper_17-10010245.sar'

...
sap_swpm_templates_install_dictionary:
  ...
  # SAP NetWeaver AS for ABAP 7.52 > SAP ASE > Installation > Application Server ABAP > Standard System
  sap_nwas_752_sp00_abap_sapase_onehost:
    ...
    softwarecenter_search_list_x86_64:
      ...
      - 'SWPM10SP42_5-20009701.SAR'
      - 'igsexe_13-80003187.sar' # IGS 7.53
      - 'igshelper_17-10010245.sar'
      - 'SYBCTRL_1427-80002616.SAR'
      - '51057961_1' # SAP ASE 16.0.04.06 HF1 RDBMS Linux on x86_64 64bit
      - 'ASEBC16004P_6-20012477.SAR' # SAP ASE 16.0 FOR BUS. SUITE DBCLIENT SP04 Patch Level x (e.g. 03)
  ...
  sap_nwas_750_sp00_abap_sapase_onehost:

...
sap_swpm_templates_install_dictionary:
  ...
  sap_ecc6_ehp8_oracledb_onehost:
    ...
    softwarecenter_search_list_x86_64:
      ...
      - 'DBATL740O11_47-80002605.SAR' # DBATOOLS Package for Oracle 11g, 12c and higher, Support Package SAP KERNEL 7.53 64-BIT UNICODE Linux on x86_64 64bit ORACLE

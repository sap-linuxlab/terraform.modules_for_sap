...
sap_swpm_templates_install_dictionary:
  ...
  sap_bw4hana_2021_onehost_install:
    ...
    softwarecenter_search_list_x86_64:
      ...
      - '19118000000000006190'
      - '19118000000000006191'
      - '19118000000000006192'
      - '19118000000000006193'
      - '19118000000000006194'
      - '19118000000000006195'
      - '19118000000000006196'
      - '19118000000000006197'
#      - 'BW4HANA300_NW_LANG_EN.SAR'

    softwarecenter_search_list_ppc64le:
      - 'SAPCAR_1115-70006238.EXE'
      - 'IMDB_SERVER20_067_3-80002046.SAR'
      - 'IMDB_LCAPPS_2066_0-80002183.SAR'
      - 'IMDB_AFL20_066_0-80002045.SAR'
      - 'IMDB_CLIENT20_017_22-80002095.SAR' # SAP HANA Client
      - 'SWPM20SP15_5-80003426.SAR'

...
sap_swpm_templates_install_dictionary:
  ...
  # SAP NetWeaver AS for ABAP 7.52 > MaxDB > Installation > Application Server ABAP > Standard System
  sap_nwas_752_sp00_abap_sapmaxdb_onehost:
  ...
  sap_nwas_750_sp00_abap_sapmaxdb_onehost:

...
resource "null_resource" "dns_resolv_files" {
  ...
  depends_on = [
    aws_route53_record.dns_resource_record_a
  ]
...
nameserver ${var.module_var_dns_nameserver_list[0]}
nameserver ${var.module_var_dns_nameserver_list[1]}
...
echo 'Running dig @${var.module_var_dns_nameserver_list[0]} A ${var.module_var_host_name}.${var.module_var_dns_root_domain_name}'
dig @${var.module_var_dns_nameserver_list[0]} A ${var.module_var_host_name}.${var.module_var_dns_root_domain_name}

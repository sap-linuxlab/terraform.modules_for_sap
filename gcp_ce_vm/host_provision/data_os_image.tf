...
data "google_compute_image" "host_os_image" {
  project = var.module_var_host_os_image.project // The project must be set to the GCP Marketplace Product owner as the GCP OS 'Public Image Project', e.g. rhel-cloud, rhel-sap-cloud, suse-cloud, suse-sap-cloud
  family  = var.module_var_host_os_image.family
}
